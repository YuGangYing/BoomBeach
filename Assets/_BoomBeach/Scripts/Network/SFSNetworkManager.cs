...
{
	public static string CMD_Collect = "collect";//收集资源
	public static string CMD_CreateBuilding = "createBuilding";//创建建筑
	public static string CMD_UpgradeBuilding = "upgradeBuilding";//升级建筑
	public static string CMD_UpgradeTrooper = "upgradeCharacter";//升级士兵
	public static string CMD_UpgradeTech = "upgradeTech";//升级科技


	public static string CMD_SpeedUP = "speedUp";//立即完成升级仅升级过程中（建筑升级，科技升级，士兵升级）
	public static string CMD_Train = "train";//训练士兵
	public static string CMD_TrainAll = "trainAll";//训练所有士兵
	public static string CMD_ImmediatelyUp ="immediatelyUp";//立即完成升级仅面板（建筑升级，科技升级，士兵升级）
	public static string CMD_SpeedUPTrain = "speedUpTrain";//立即完成士兵训练
	public static string CMD_SpeedUPTrainAll = "speedUpTrainAll";//立即完成所有士兵训练
	public static string CMD_MoveBuilding = "changeXY";//移动建筑
	public static string CMD_BuildDone = "buildingActionDone";//建筑自然完成
	public static string CMD_TrooperUpgradeDone = "soldierActionDone";
	public static string CMD_TechUpgradeDone = "spellActionDone";
	public static string CMD_CancelBuilding = "cancelBuilding";//取消建筑操作
	public static string CMD_CancelTech = "cancelTech";//取消科技升级
	public static string CMD_CancelSoilder="cancelSoilder";//取消士兵升级
	public static string CMD_CancelTraining="cancelTrain";//取消士兵训练
