...
namespace BattleFramework.Data{
	...
	public class CSVFileReader
	{
        ...
        public List<string> listColumnType { get { return m_listTypes; } }//csv column comment,read only;
...
//                        startI = 1;
//
//                    for (int i = startI; i < strLine.Length; i++)
//	                {
//	                    char c = strLine[i];
//	                    //char cEx = '\0'; // 空值
//	                    //if ((i + 1) < strLine.Length)
...
//                            }
//                        }
//                        if (!isJoin && c == mSplitMark) // read field   // 
//                        {
