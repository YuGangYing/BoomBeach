Shader "MyShader/BoomBeachOceanShader" {
    Properties {
        ...
        SubShader {
			...
			varying vec2 v_worldPos;
             ...
             {                  
				...
				gl_FragColor = mix(gl_FragColor, vec4(0.95, 0.95, 0.95, gl_FragColor.a), min(1.0, texture2D(foam, v_foamUv).r * v_foamPower)) * (texture2D(lightmap, v_worldPos) * 1.3);
