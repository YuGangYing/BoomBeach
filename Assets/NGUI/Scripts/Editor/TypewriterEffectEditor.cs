...
public class TypewriterEffectEditor : Editor
{
	public override void OnInspectorGUI ()
	{
        ...
        //System.Collections.Generic.List<EventDelegate> delegateList = new System.Collections.Generic.List<EventDelegate>();
        //delegateList.Add(tw.onFinished);

        //NGUIEditorTools.DrawEvents("On Finished", tw, delegateList);
