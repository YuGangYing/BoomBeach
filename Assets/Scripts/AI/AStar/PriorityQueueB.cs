...
using PathFinding.Core;
	...
	/*
		...
		*/
        ...
        public PriorityQueueB(PathFinderNodeFast[] matrix)
		{
			mMatrix = matrix;
		}	
		#endregion
        ...
        protected virtual int OnCompare(int i, int j)
        {
			...
			if (mMatrix[InnerList[i]].F > mMatrix[InnerList[j]].F)
                    return 1;
             else if (mMatrix[InnerList[i]].F < mMatrix[InnerList[j]].F)
                   return -1;
             return 0;		
        }	
		/// <summary>
