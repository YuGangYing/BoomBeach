...
namespace BoomBeach
{
    ...
    public class BattleInterfacePanelView : PanelBase
    {
        ...
        {
            m_Trans = transform;
            m_txtGoldnum = m_Trans.Find("container_resources/item/#txt_goldnum").GetComponent<Text>();
            m_txtGoldnumadd = m_Trans.Find("container_resources/item/#txt_goldnumadd").GetComponent<Text>();
            m_txtWoodnum = m_Trans.Find("container_resources/item (1)/#txt_woodnum").GetComponent<Text>();
            m_txtWoodnumadd = m_Trans.Find("container_resources/item (1)/#txt_woodnumadd").GetComponent<Text>();
            m_txtStonenum = m_Trans.Find("container_resources/item (2)/#txt_stonenum").GetComponent<Text>();
            m_txtStonenumadd = m_Trans.Find("container_resources/item (2)/#txt_stonenumadd").GetComponent<Text>();
            m_txtIronnum = m_Trans.Find("container_resources/item (3)/#txt_ironnum").GetComponent<Text>();
            m_txtIronnumadd = m_Trans.Find("container_resources/item (3)/#txt_ironnumadd").GetComponent<Text>();
            m_txtMedalnum = m_Trans.Find("container_resources/item (4)/#txt_medalnum").GetComponent<Text>();
            m_imgSmall = m_Trans.Find("container_chance/item/#img_small").GetComponent<Image>();
            m_imgMiddle = m_Trans.Find("container_chance/item/#img_middle").GetComponent<Image>();
            m_imgBig = m_Trans.Find("container_chance/item/#img_big").GetComponent<Image>();
            m_txtMedalnumadd = m_Trans.Find("container_chance/item (1)/#txt_medalnumadd").GetComponent<Text>();
            m_txtEnergy = m_Trans.Find("#container_energy/#txt_energy").GetComponent<Text>();
            m_containerEnergy = m_Trans.Find("#container_energy").gameObject;
            m_imgSelectweapon = m_Trans.Find("#img_selectweapon").GetComponent<Image>();
            m_imgSelecttroop = m_Trans.Find("#img_selecttroop").GetComponent<Image>();
            m_containerTroops = m_Trans.Find("#container_troops").gameObject;
            m_containerViewtroops = m_Trans.Find("#container_battleview/#container_viewtroops").gameObject;
            m_containerBattleview = m_Trans.Find("#container_battleview").gameObject;
            m_containerWeapons = m_Trans.Find("#container_weapons").gameObject;
            ...
            m_btnEnd = m_Trans.Find("#btn_end").GetComponent<Button>();
            m_txtAttackgold = m_Trans.Find("#btn_battle/#txt_attackgold").GetComponent<Text>();
            m_btnBattle = m_Trans.Find("#btn_battle").GetComponent<Button>();
            m_btnMap = m_Trans.Find("#btn_map").GetComponent<Button>();
            m_btnIronfill = m_Trans.Find("#container_resourcebar/#slider_iron/Fill Area/#btn_ironfill").GetComponent<Button>();
            ...
            m_btnStonefill = m_Trans.Find("#container_resourcebar/#slider_stone/Fill Area/#btn_stonefill").GetComponent<Button>();
            ...
            m_btnWoodfill = m_Trans.Find("#container_resourcebar/#slider_wood/Fill Area/#btn_woodfill").GetComponent<Button>();
            ...
            m_btnGoldfill = m_Trans.Find("#container_resourcebar/#slider_gold/Fill Area/#btn_goldfill").GetComponent<Button>();
