...
//		blend srcalpha oneminussrcalpha
		pass
		{
			...
			v2f vert (vertexinput v)
			{
				v2f o;
				o.uv = v.texcoord;
				o.uv.w = clamp(1-abs(o.uv.x-0.5)*2 +0.4,0,1);
//				o.uv.w *= clamp(1-abs(o.uv.y-0.5)*2 +0.4,0,1);
...
//				tex1.rgb*=tex1.a;
				...
				tex1.a = (tex1.a * tex2.r*_Emission + tex2.r*0.2)*i.uv.z;
